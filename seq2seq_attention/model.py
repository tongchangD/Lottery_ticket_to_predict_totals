...
class EncoderRNN(nn.Module):
    def __init__(self, input_size, hidden_size, \
        ...
        #self.gru = nn.GRU(hidden_size, hidden_size, n_layers)  # tcd

    def forward(self, word_inputs, hidden, cell):
        word_inputs = torch.transpose(word_inputs, 1, 0)  # T x N # 二维矩阵
...
class AttnDecoderRNN(nn.Module):
    def __init__(self, attn_model, hidden_size, output_size, n_layers=1, dropout_p=0.1):
        ...
        #self.gru = nn.GRU(hidden_size * 2, hidden_size,n_layers, dropout=dropout_p)  # tcd
