...
def predict_and_write(predictor, sources_batch, previous_line_list, context_list, writer, num_predicted, start_time,
                      batch_num):
        ...
        for batch_id in range(batch_num):
            ...
            for source in sources_batch:
                ...
                for char in source[0]:
                    if (char >= '0' and char <= '9') or char in '.- ' or (char >= 'a' and char <= 'z') or (
                            char >= 'A' and char <= 'Z'):
                ...
                if prediction_A == prediction_B:  # 其中一个换为source
                    ...
                    if lcsA < 8:  # A的变化大
                        ...
                        if lcsA <= lcsB:  # A的变化大
                            ...
                            print(curLine(), batch_id, prediction_A, prediction_B, "target:", target,
                                  "current_batch_size=",
            ...
            if batch_id % 20 == 0:
                ...
                print(curLine(), id, prediction_A, prediction_B, "target:", target, "current_batch_size=",
                      current_batch_size)
                print(curLine(), id, "sourceA:", sourceA, "sourceB:", sourceB, "target:", target)
