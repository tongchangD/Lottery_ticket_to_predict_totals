...
# 参数 --training_file=./output/train.tf_record --eval_file=./output/tune.tf_record --label_map_file=./output/label_map.txt --model_config_file=./configs/lasertagger_config.json --output_dir=./output/models/wikisplit_experiment_name  --init_checkpoint=./data/RoBERTa-tiny-clue/bert_model.ckpt --do_train=true  --do_eval=true --train_batch_size=256 --save_checkpoints_steps=200 --max_seq_length=40 --num_train_examples=310922 --num_eval_examples=5000
# 参数 --label_map_file=./output/label_map.txt --model_config_file=./configs/lasertagger_config.json --output_dir=./output/models/wikisplit_experiment_name --do_export=true --export_path=./output/models/wikisplit_experiment_name/export
...
flags.DEFINE_bool("use_tpu", False, "Whether to use TPU or GPU/CPU.")  # tcd
flags.DEFINE_string(
    "tpu_name", None,
...
def main(_):
    tf.logging.set_verbosity(tf.logging.INFO)  # tcd
    ...
    if FLAGS.do_train:
        print("FLAGS.training_file", FLAGS.training_file)
    ...
    #
    #     for ckpt in tf.contrib.training.checkpoints_iterator(FLAGS.output_dir, timeout=FLAGS.eval_timeout):
    #         print("ckpt",ckpt)
